...
const ABOUT_CARDS = [
  {
    icon: '🌿',
    title: 'Nguyên liệu cao nguyên',
    desc: 'Trà thượng hạng từ nguồn nguyên liệu uy tín',
  },
  { icon: '🧋', title: 'Topping homemade', desc: 'Tạo nên dấu ấn riêng biệt không thể trộn lẫn' },
  {
    icon: '🤝',
    title: 'Hệ sinh thái tin cậy',
    desc: 'Đồng hành trọn gói từ công thức đến vận hành',
  },
