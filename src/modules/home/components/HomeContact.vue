<template>
  <section id="lien-he" class="tw:py-16 bg-primary">
    <v-container>
            ...
            <div v-for="info in CONTACT_INFO" :key="info.label" class="d-flex align-center ga-3">
              ...
              <div>
                ...
                <component
                  ...
                  class="text-on-primary font-weight-medium text-decoration-none"
                >
                  {{ info.value }}
                </component>
              </div>
          ...
          <v-card rounded="xl" class="pa-6">
            ...
            <v-form ref="formRef" @submit.prevent="handleSubmit">
              ...
              <v-btn
                ...
                :prepend-icon="isSubmitted ? mdiCheck : undefined"
              >
...
import { mdiCheck, mdiPhone, mdiWeb, mdiEmail, mdiMapMarker } from '@mdi/js'
import type { ContactForm } from '../types/home.types'
...
const requiredRule = [(v: string) => !!v || 'Trường này bắt buộc']

const CONTACT_INFO: { icon: string; label: string; value: string; href: string | null }[] = [
  { icon: mdiPhone, label: 'Hotline nhượng quyền', value: '0985 978 456', href: null },
  { icon: mdiWeb, label: 'Website', value: 'soliteavn.com', href: 'https://soliteavn.com' },
  {
    icon: mdiEmail,
    label: 'Email',
    value: 'haianhbg01@gmail.com',
    href: 'mailto:haianhbg01@gmail.com',
  },
  {
    icon: mdiMapMarker,
    label: 'Trụ sở',
    value: '211 Nam Kỳ Khởi Nghĩa, Vũng Tàu, TP.HCM',
    href: null,
  },
]
