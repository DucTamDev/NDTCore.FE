...
import type { Benefit, DrinkItem, FaqItem, InvestRow, MenuTab, ProcessStep } from './home.types'
...
export const ALL_MENU: DrinkItem[] = [
    ...
    },
    {
        ...
        desc: 'Olong, thạch aiyu, kem phô mai',
        price: '23K',
    },
    {
        cat: 'milk-tea',
    ...
    },
    {
        ...
        name: 'Thanh Trà Phúc Bồn Tử',
        desc: 'Trà xanh hoa nhài, phúc bồn tử, thạch aiyu',
        price: '22K',
    },
    {
        cat: 'fruit',
        ...
        name: 'Sen Long Nhãn',
        desc: 'Trà sen, hạt sen, nhãn quả, thạch aiyu',
        price: '30K',
    },
    {
        cat: 'fruit',
        ...
        desc: 'Trà sen hoặc olong kết hợp vải, thạch aiyu',
        price: '30K',
    },
    {
        cat: 'fruit',
        ...
        desc: 'Lục trà xanh, hạt sen, xoài, thạch aiyu, kem phô mai',
        price: '27K',
    },
    {
        cat: 'matcha',
        imgUrl: IMG.olong_sua,
        name: 'Matcha Latte',
        desc: 'Sữa tươi kết hợp matcha Nhật thượng hạng',
        price: '29K',
    },
    {
        cat: 'matcha',
        ...
        desc: 'Sữa tươi kết hợp matcha Nhật cùng lớp kem cheese',
        price: '33K',
    },
    {
        cat: 'fresh',
...
export const BENEFITS: Benefit[] = [
    { num: '01', title: 'Mô hình bền vững', desc: 'Lợi nhuận ổn định với quy trình đã chuẩn hóa.' },
    {
        ...
        desc: 'Chỉ từ 150 đến 250 triệu để khởi động.',
    },
    ...
    { num: '04', title: 'Hỗ trợ trọn gói', desc: 'Đào tạo A-Z, setup và hỗ trợ khai trương.' },
    {
        ...
        desc: 'Phù hợp nhiều diện tích và khu vực khác nhau.',
    },
...
export const FAQS: FaqItem[] = [
    {
        ...
        a: 'Được. Mô hình đã chuẩn hóa và có đào tạo chi tiết.',
    },
    {
        q: 'Tôi đang có sẵn mặt bằng thì sao?',
        a: 'Đội ngũ sẽ khảo sát và tư vấn setup phù hợp với mặt bằng thực tế.',
    },
    {
        q: 'Có phải nhập nguyên liệu toàn bộ từ Soli không?',
        a: 'Chỉ các nhóm nguyên liệu cần đồng nhất chất lượng mới cần theo chuẩn Soli.',
    },
    ...
    {
        q: 'Có hợp đồng cam kết không?',
        a: 'Có. Điều khoản rõ ràng về quyền lợi và trách nhiệm của hai bên.',
    },
]
